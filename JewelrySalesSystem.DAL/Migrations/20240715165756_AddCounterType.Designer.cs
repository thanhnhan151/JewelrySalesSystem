...
namespace JewelrySalesSystem.DAL.Migrations
{
    ...
    [Migration("20240715165756_AddCounterType")]
    partial class AddCounterType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JewelrySalesSystem.DAL.Entities.CounterType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("CounterTypeName")
                        .IsRequired()
                        .HasMaxLength(8)
            ...
            modelBuilder.Entity("JewelrySalesSystem.DAL.Entities.Counter", b =>
                {
                    b.HasOne("JewelrySalesSystem.DAL.Entities.CounterType", "CounterType")
                        .WithMany("Counters")
                        .HasForeignKey("CounterTypeId");

                    b.Navigation("CounterType");
                });
            ...
            modelBuilder.Entity("JewelrySalesSystem.DAL.Entities.User", b =>
                {
                    b.HasOne("JewelrySalesSystem.DAL.Entities.Counter", "Counter")
                        .WithOne("User")
                        .HasForeignKey("JewelrySalesSystem.DAL.Entities.User", "CounterId");
